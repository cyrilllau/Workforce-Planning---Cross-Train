...
def main():
    ...
    for alpha in alpha_values:
        ...
        #     print(f"Results for alpha = {alpha} already exist. Skipping computation.")
        #     continue

        print(f"\nRunning model for alpha = {alpha}")
        # Initialize and train the model with default B = 4, w1 = 1, w2 = 0
        cross_training_model = CrossTrainingExtensive(training_sections, B=4, alpha=alpha, w1=1, w2=0)
        cross_training_model.train()
        cross_training_model.extract_solution()
